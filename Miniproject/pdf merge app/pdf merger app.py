...
btn_open = tk.Button(fr_bg1, text="Browse pdf1",bg='#C0C0C0', fg='black', font=('helvetica', 12, 'bold'),
...
btn_open = tk.Button(fr_bg1, text="Browse pdf2",bg='#C0C0C0', fg='black', font=('helvetica', 12, 'bold'),
                     command=lambda: open_file(filelist))
btn_open.grid(row=1, column=0, sticky="ew", padx=5)
lbl_items = tk.Label(fr_bg1, text="")
...
lbl_to_merge = tk.Label(fr_bg2, text="enter the filename pdf to be saved!!")
...
btn_merge = tk.Button(fr_bg2,
                      text="Merge PDF",
                      state="disabled",bg='#C0C0C0', fg='black', font=('helvetica', 12, 'bold'),
